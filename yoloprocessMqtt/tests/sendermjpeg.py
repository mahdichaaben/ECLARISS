...
# Define the FFmpeg command to send frames to the RTSP server using MJPEG codec
ffmpeg_command = [
    'ffmpeg',
    '-re',  # Read input at the native frame rate
    '-f', 'rawvideo',  # Input format
    '-pix_fmt', 'yuvj420p',  # Pixel format for MJPEG encoding
    ...
    '-c:v', 'mjpeg',  # Encode video as MJPEG
