...
if __name__ == "__main__":
    stream = CameraStream(
        mqtt_client_id="gardencameradevice",
        mqtt_username="camera2device",
        mqtt_password="Camera2device",
        mqtt_broker="3295446499b64d298ec2ec27690e9fdf.s1.eu.hivemq.cloud",
        mqtt_port=8883,
        rtsp_url='rtsp://192.168.1.12:8554/source'
    )
    stream.run()
