...
if __name__ == "__main__":
    user_id = "admin"
    camera_id = "camera1"
    rtsp_source_url = "rtsp://localhost:8554/camera1"  # Replace with your RTSP source URL
    rtsp_destination_url = "rtsp://localhost:8554/camera1smart"  # Replace with your RTSP destination URL
